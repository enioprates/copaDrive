...
#include <ros_its_msgs/OMNET_CAM.h>
...
namespace gazebo
{
  ...
  class PriusHybridPlugin : public ModelPlugin
  {
    ...
    /// \brief Network RX
    private: void OnNetworkRX(const ros_its_msgs::CAM_simplified::ConstPtr& msg);

    /// \brief Network TX
    private: void OnNetworkTX(const ros_its_msgs::CAM_simplified::ConstPtr& msg);
