...
"""autogenerated by genpy from image_processing/AckermannDriveStamped.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct

import image_processing.msg
import std_msgs.msg

class AckermannDriveStamped(genpy.Message):
  _md5sum = "1fd5d7f58889cefd44d29f6653240d0c"
  _type = "image_processing/AckermannDriveStamped"
...
"""
  ...
  _slot_types = ['std_msgs/Header','image_processing/AckermannDrive']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.drive is None:
        self.drive = image_processing.msg.AckermannDrive()
    else:
      self.header = std_msgs.msg.Header()
      self.drive = image_processing.msg.AckermannDrive()
