...
(cl:defclass <AckermannDriveStamped> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (drive
    :reader drive
    :initarg :drive
    :type image_processing-msg:AckermannDrive
    :initform (cl:make-instance 'image_processing-msg:AckermannDrive)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <AckermannDriveStamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AckermannDriveStamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name image_processing-msg:<AckermannDriveStamped> is deprecated: use image_processing-msg:AckermannDriveStamped instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <AckermannDriveStamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader image_processing-msg:header-val is deprecated.  Use image_processing-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'drive-val :lambda-list '(m))
(cl:defmethod drive-val ((m <AckermannDriveStamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader image_processing-msg:drive-val is deprecated.  Use image_processing-msg:drive instead.")
  (drive m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<AckermannDriveStamped>)))
  ...
  "image_processing/AckermannDriveStamped")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'AckermannDriveStamped)))
  "Returns string type for a message object of type 'AckermannDriveStamped"
  "image_processing/AckermannDriveStamped")
