...
def grava_dados_TV():
	...
	if count_TV == 0:
		with open('/home/enio/Desktop/ROSintegrationPlatooning/carving/CISTER_image_processing/src/image_processing/log_position_TV.csv', mode='w') as log_position_file:
                	...
                	log_writer.writerow(['count','latitude_TV', 'longitude_TV', 'speed_TV','speed km','heading_TV','lap'])
			log_writer.writerow([count_TV,latitude_TV, longitude_TV,speed_TV, speed_TV * 3.6, heading_TV, lap_TV])
		count_TV = count_TV + 1
	else :
...
def grava_dados_SV():
	...
	if count_SV == 0:
		with open('/home/enio/Desktop/ROSintegrationPlatooning/carving/CISTER_image_processing/src/image_processing/log_position_SV.csv', mode='w') as log_position_file:
               		log_writer = csv.writer(log_position_file, delimiter=';', quotechar='"', quoting=csv.QUOTE_MINIMAL)
                	log_writer.writerow(['count_SV','latitude_SV', 'longitude_SV', 'speed_SV','speed km','heading_SV','PID Error','Theta Error','lap_SV'])
			log_writer.writerow([count_SV,latitude_SV, longitude_SV,speed_SV, speed_SV * 3.6, heading_SV, PID_error, THETA_error,lap_SV])
        	count_SV = count_SV + 1
	else :
		with open('/home/enio/Desktop/ROSintegrationPlatooning/carving/CISTER_image_processing/src/image_processing/log_position_SV.csv', mode='a') as log_position_file:
                	log_writer = csv.writer(log_position_file, delimiter=';', quotechar='"', quoting=csv.QUOTE_MINIMAL)
                	log_writer.writerow([count_SV,latitude_SV, longitude_SV, speed_SV,speed_SV * 3.6, heading_SV, PID_error, THETA_error, lap_SV])
		count_SV = count_SV + 1
