...
#--------------------------
#Topico a publicar
pub=rospy.Publisher('X_Y', coords, queue_size=10)
lines_old = (0,0,0)
class image_converter:
  
  def __init__(self):
    self.image_pub = rospy.Publisher("/camera/image_topic_2",Image,queue_size=10)

    self.bridge = CvBridge()
    self.image_sub = rospy.Subscriber("/car1/front_camera/image_raw",Image,self.callback)
