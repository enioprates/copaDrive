...
lap_SV = 0
count_lap_SV = 0
init_lat_SV = 160			#OVAL: 160		#curve: 160.0
...
def grava_dados_TV():
	...
	if GRAVA_SONAR:
		if count_TV == 0:
			with open('/home/enio/OneDrive/Cister/ROS/Inline/CISTER_image_processing/src/image_processing/log_position_TV_'+TV_name+'.csv', mode='w') as log_position_file:
			...
			with open('/home/enio/OneDrive/Cister/ROS/Inline/CISTER_image_processing/src/image_processing/log_position_TV_'+TV_name+'.csv', mode='a') as log_position_file:
				log_writer = csv.writer(log_position_file, delimiter=';', quotechar='"', quoting=csv.QUOTE_MINIMAL)
				log_writer.writerow([tp.time()-time_base, count_TV,latitude_TV, longitude_TV, speed_TV,speed_TV * 3.6,heading_TV,lap_TV, range_LF, range_LM, range_RM, range_RF, range_side_L, range_side_R])
			count_TV = count_TV + 1
	else:
