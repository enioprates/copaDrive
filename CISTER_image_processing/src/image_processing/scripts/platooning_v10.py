...
kd_dis = 2.0        #0.3                                #Distance Derivative Controller
...
kp_theta = 2.0      #5.0    #6.0                        #Angle Proportional Controller
ki_theta = 0.005     #0.005    #0.05                      #Angle Integral Controller
kd_theta = 1.0      #1.0    #3.0                        #Angle Derivative Controller
