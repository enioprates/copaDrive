...
legend('Leader','SV1','SV2','SV3','SV4','SV5','SV6','SV7','SV8','SV9','SV10');
hold off
...
plot(data_pid(1:tam,1)',data_sv11(1:end,used_coluumn)')
...
labels = {'Leader-SV1','SV1-SV2','SV2-SV3', 'SV3-SV4','SV4-SV5', 'SV5-SV6','SV6-SV7', 'SV7-SV8','SV8-SV9', 'SV9-SV10'};
%labels = {'SV1-SV2','SV2-SV3'};
...
%SV11
tam = size(data_sv11(:,used_coluumn),1);
plot(data_pid(1:tam,1)'+5,data_sv11(:,used_coluumn)')


title({'Theta Comparison:','With and Without Look Ahead Controller (LAC)'});
xlabel ('Time (s)');
ylabel('Theta (rad)');
legend('Leader','SV9: Without LAC','SV11: With LAC');
...
%SV6
tam = size(data_sv6(:,used_coluumn),1);
plot(data_pid(10:tam,1)',data_sv6(10:tam,used_coluumn)')
%SV7
tam = size(data_sv7(:,used_coluumn),1);
plot(data_pid(10:tam,1)',data_sv7(10:tam,used_coluumn)')
%SV8
tam = size(data_sv8(:,used_coluumn),1);
plot(data_pid(10:tam,1)',data_sv8(10:tam,used_coluumn)')
%SV9
tam = size(data_sv9(:,used_coluumn),1);
plot(data_pid(10:tam,1)',data_sv9(10:tam,used_coluumn)')
%SV10
tam = size(data_sv10(:,used_coluumn),1);
plot(data_pid(10:tam,1)',data_sv10(10:tam,used_coluumn)'+1)
%SV11
tam = size(data_sv11(:,used_coluumn),1);
plot(data_pid(10:tam,1)',data_sv11(10:tam,used_coluumn)')

title('Vehicle Inter-Distance');
xlabel ('Time (s)');
ylabel('Distance (m)');
legend('Leader-SV1','SV1-SV2','SV2-SV3', 'SV3-SV4','SV4-SV5', 'SV5-SV6','SV6-SV7', 'SV7-SV8','SV8-SV9', 'SV9-SV10');
%ylim([-1 10]);
%xticks(0:10:500);
hold off
